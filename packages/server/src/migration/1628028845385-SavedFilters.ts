...
export class SavedFilters1628028845385 implements MigrationInterface {

  name = 'SavedFilters1628028845385';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "saved_filter_entity_type_enum" AS ENUM('Observation', 'RosterEntry')`);
    await queryRunner.query(`CREATE TABLE "saved_filter" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "entity_type" "saved_filter_entity_type_enum" NOT NULL, "config" json NOT NULL DEFAULT '{}', "org_id" integer NOT NULL, CONSTRAINT "PK_efff8142c6db3d6ed6f47bc2719" PRIMARY KEY ("id"))`);
