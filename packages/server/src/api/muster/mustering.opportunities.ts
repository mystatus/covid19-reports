 ...
 */
export async function getMusteringOpportunities(orgId: number, unitIds: number[], startDate: moment.Moment, endDate: moment.Moment): Promise<MusteringOpportunities> {
 ...
 * @param endDate The end date for the generation of time muster opportunities
 */
export function toMusterOpportunities(musterConf: MusterConfWithDateArray, startDate: moment.Moment, endDate: moment.Moment): MusterWindowWithStartAndEndDate[] {
