...
const SidenavLink = (props: SidenavLinkProps) => {
  ...
  return (
    <Link className={isActive() ? classes.activeLink : classes.inactiveLink} {...rest}>
...
export const AppSidenav = (props: { savedLayouts: SavedLayoutSerialized[] }) => {
  ...
  return (
    <div className={classes.root}>
      <div
        className={clsx(classes.expander, {
      ...
      >
        ...
        <List>
          <SidenavLink to="/home" name="Home" icon={<HomeIcon />} />
          {userHasWorkspaces() && <SidenavLink to="/spaces" name="Spaces" icon={<BarChartIcon />} />}
          {userHasWorkspaces() && <SidenavLink to="/data-export" name="Data Export" icon={<DataExportIcon />} />}
          {user.activeRole?.role.canViewMuster && <SidenavLink to="/muster" name="Muster" icon={<PersonCheckIcon />} />}
        ...
        {user.activeRole?.role.canManageGroup && (
          <>
            ...
            <List>
              <SidenavLink to="/units" name="Units" icon={<GroupWorkIcon />} />
              <SidenavLink to="/users" name="Users" icon={<SupervisorAccountIcon />} />
              <SidenavLink to="/roles" name="Roles" icon={<SecurityIcon />} />
              <SidenavLink to="/roster-columns" name="Roster Columns" icon={<ViewWeekOutlinedIcon />} />
              <SidenavLink to="/edit-spaces" name="Edit Spaces" icon={<DashboardOutlinedIcon />} />
            </List>
          </>
        )}
