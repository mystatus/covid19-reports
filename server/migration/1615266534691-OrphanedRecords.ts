...
export class OrphanedRecords1615266534691 implements MigrationInterface {
  name = 'OrphanedRecords1615266534691';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "orphaned_record_action" ("id" character varying NOT NULL, "created_on" TIMESTAMP NOT NULL DEFAULT now(), "expires_on" TIMESTAMP NOT NULL, "type" "orphaned_record_action_type_enum" NOT NULL DEFAULT 'ignore', "user_edipi" character varying(10) NOT NULL, CONSTRAINT "PK_91e12ce795c8b2eeaecda2bab61" PRIMARY KEY ("id", "user_edipi"))`);
