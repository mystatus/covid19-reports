...
export class OrphanedRecords1614222772952 implements MigrationInterface {
  name = 'OrphanedRecords1614222772952';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "orphaned_record" ("document_id" character varying NOT NULL, "join_key" character varying NOT NULL, "edipi" character varying(10) NOT NULL, "unit" character varying NOT NULL, "phone" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "deleted_on" TIMESTAMP DEFAULT null, "org_id" integer, CONSTRAINT "PK_a41e13571c91cc4960e6d7d21f9" PRIMARY KEY ("document_id"))`);
    await queryRunner.query(`CREATE TYPE "orphaned_record_action_type_enum" AS ENUM('claim', 'ignore')`);
    await queryRunner.query(`CREATE TABLE "orphaned_record_action" ("id" character varying NOT NULL, "created_on" TIMESTAMP NOT NULL DEFAULT now(), "expires_on" TIMESTAMP NOT NULL DEFAULT now() + interval '1 day', "type" "orphaned_record_action_type_enum" NOT NULL DEFAULT 'ignore', "user_edipi" character varying(10) NOT NULL, CONSTRAINT "PK_91e12ce795c8b2eeaecda2bab61" PRIMARY KEY ("id", "user_edipi"))`);
