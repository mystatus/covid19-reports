...
import {
  ...
  RosterEntryData,
  RosterFileRow,
} from 'covid19-reports-shared/src/roster.types';
...
class ExportController {
  ...
  async exportOrgToCsv(req: ApiRequest<null, null, ExportOrgQuery>, res: Response) {
    ...
    //
    // Get ES data and stream to covid19-reports-client.
    //
    ...
    while (scrollQueue.length) {
      ...
      // Send the total hits before the first chunk so the covid19-reports-client can calculate progress.
