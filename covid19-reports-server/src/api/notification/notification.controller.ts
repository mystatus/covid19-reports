...
} from 'covid19-reports-shared/src/api/notification.api.types';
import {
  ApiRequest,
  OrgParam,
  OrgSettingParams,
...
// Remove message templates and other information that doesn't need to be sent to the covid19-reports-client
...
// Remove extra information that doesn't need to be sent to the covid19-reports-client
