...
export class UpdateWorkspaceTemplates1611951040863 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await replaceWorkspaceTemplates(kibanaSavedObjectsMock, queryRunner);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await replaceWorkspaceTemplates(kibanaSavedObjectsMockPrevious, queryRunner);
  }

}

async function replaceWorkspaceTemplates(kibanaSavedObjects: any, queryRunner: QueryRunner) {
