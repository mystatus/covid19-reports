...
export const kibanaSavedObjectsMock = {
  phi: [
    ...
    {
      "_id": "c1518e70-a9e3-11eb-b0e5-cf2d289da706",
      "_type": "dashboard",
      "_source": {
        "title": "Individual feverish or has a condition follow-up",
        "hits": 0,
        "description": "List of individuals whose most recently reported symptoms include \"Fever\" or some form of condition (e.g. chest pain)",
        "panelsJSON": "[{\"embeddableConfig\":{},\"gridData\":{\"x\":35,\"y\":0,\"w\":13,\"h\":15,\"i\":\"3\"},\"id\":\"29154300-4533-11eb-ad41-4d6b4e8c461f\",\"panelIndex\":\"3\",\"type\":\"visualization\",\"version\":\"6.4.1\"},{\"embeddableConfig\":{},\"gridData\":{\"x\":0,\"y\":0,\"w\":35,\"h\":15,\"i\":\"5\"},\"id\":\"39b68aa0-a9f8-11eb-b0e5-cf2d289da706\",\"panelIndex\":\"5\",\"type\":\"visualization\",\"version\":\"6.4.1\"},{\"gridData\":{\"x\":0,\"y\":15,\"w\":48,\"h\":30,\"i\":\"6\"},\"version\":\"6.4.1\",\"panelIndex\":\"6\",\"type\":\"visualization\",\"id\":\"c168acb0-adc4-11eb-b5bf-0bb0cc9d042b\",\"embeddableConfig\":{}}]",
        "optionsJSON": "{\"darkTheme\":false,\"hidePanelTitles\":false,\"useMargins\":true}",
        "version": 1,
        "timeRestore": true,
        "timeTo": "now",
        ...
        "kibanaSavedObjectMeta": {
          "searchSourceJSON": "{\"query\":{\"language\":\"lucene\",\"query\":\"\"},\"filter\":[{\"$state\":{\"store\":\"appState\"},\"meta\":{\"alias\":\"Fever or any Condition\",\"disabled\":false,\"index\":\"a8de1010-2532-11eb-aa43-cf97fefcff0e\",\"key\":\"query\",\"negate\":false,\"type\":\"custom\",\"value\":\"{\\\"bool\\\":{\\\"filter\\\":{\\\"bool\\\":{\\\"should\\\":[{\\\"term\\\":{\\\"Details.Symptoms.keyword\\\":\\\"Fever\\\"}},{\\\"exists\\\":{\\\"field\\\":\\\"Details.Conditions.keyword\\\"}}]}}}}\"},\"query\":{\"bool\":{\"filter\":{\"bool\":{\"should\":[{\"term\":{\"Details.Symptoms.keyword\":\"Fever\"}},{\"exists\":{\"field\":\"Details.Conditions.keyword\"}}]}}}}}]}"
        }
      },
      "_meta": {
        "savedObjectVersion": 2
    ...
    },
    {
      ...
      "_source": {
        ...
        "visState": "{\"title\":\"Daily Symptoms\",\"type\":\"table\",\"params\":{\"perPage\":14,\"showPartialRows\":false,\"showMetricsAtAllLevels\":false,\"sort\":{\"columnIndex\":3,\"direction\":\"desc\"},\"showTotal\":false,\"totalFunc\":\"sum\"},\"aggs\":[{\"id\":\"2\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"EDIPI.keyword\",\"size\":5000000,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\",\"customLabel\":\"EDIPI\"},\"hidden\":false},{\"id\":\"12\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Roster.firstName.keyword\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\",\"customLabel\":\"First Name\"},\"hidden\":false},{\"id\":\"13\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Roster.lastName.keyword\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\",\"customLabel\":\"Last Name\"},\"hidden\":false},{\"id\":\"3\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Details.Symptoms\",\"aggregate\":\"concat\",\"size\":5,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\",\"customLabel\":\"Symptoms\"},\"hidden\":false},{\"id\":\"11\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Details.Conditions\",\"aggregate\":\"concat\",\"size\":5,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\",\"customLabel\":\"Conditions\"},\"hidden\":false},{\"id\":\"7\",\"enabled\":true,\"type\":\"max\",\"schema\":\"metric\",\"params\":{\"field\":\"Score\",\"customLabel\":\"Max Score\"},\"hidden\":false},{\"id\":\"9\",\"enabled\":true,\"type\":\"date_histogram\",\"schema\":\"bucket\",\"params\":{\"field\":\"Timestamp\",\"interval\":\"d\",\"customInterval\":\"7d\",\"min_doc_count\":1,\"extended_bounds\":{},\"customLabel\":\"Day\"},\"hidden\":false}]}",
        "uiStateJSON": "{\"vis\":{\"params\":{\"sort\":{\"columnIndex\":3,\"direction\":\"desc\"}}}}",
        "description": "",
        "version": 1,
        "kibanaSavedObjectMeta": {
          "searchSourceJSON": "{\"index\":\"a8de1010-2532-11eb-aa43-cf97fefcff0e\",\"query\":{\"language\":\"lucene\",\"query\":\"\"},\"filter\":[{\"query\":{\"bool\":{\"filter\":{\"bool\":{\"should\":[{\"exists\":{\"field\":\"Details.Symptoms.keyword\"}},{\"exists\":{\"field\":\"Details.Conditions.keyword\"}}]}}}},\"meta\":{\"negate\":false,\"index\":\"a8de1010-2532-11eb-aa43-cf97fefcff0e\",\"disabled\":false,\"alias\":\"Symptoms or Conditions reported\",\"type\":\"custom\",\"key\":\"query\",\"value\":\"{\\\"bool\\\":{\\\"filter\\\":{\\\"bool\\\":{\\\"should\\\":[{\\\"exists\\\":{\\\"field\\\":\\\"Details.Symptoms.keyword\\\"}},{\\\"exists\\\":{\\\"field\\\":\\\"Details.Conditions.keyword\\\"}}]}}}}\"},\"$state\":{\"store\":\"appState\"}}]}"
        }
      },
      "_meta": {
        "savedObjectVersion": 2
    ...
    {
      "_id": "c168acb0-adc4-11eb-b5bf-0bb0cc9d042b",
      "_type": "visualization",
      "_source": {
        "title": "Individual feverish or has a condition follow-up",
        "visState": "{\"title\":\"Individual feverish or has a condition follow-up\",\"type\":\"table\",\"params\":{\"perPage\":20,\"showPartialRows\":false,\"showMetricsAtAllLevels\":false,\"sort\":{\"columnIndex\":3,\"direction\":\"asc\"},\"showTotal\":false,\"totalFunc\":\"sum\"},\"aggs\":[{\"id\":\"2\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"EDIPI.keyword\",\"size\":5000,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\"},\"hidden\":false},{\"id\":\"1\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Details.Symptoms\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\"},\"hidden\":false},{\"id\":\"9\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Details.Conditions\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\"},\"hidden\":false},{\"id\":\"3\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"Timestamp\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\"},\"hidden\":false},{\"id\":\"5\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"Roster.firstName.keyword\",\"size\":5,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\",\"customLabel\":\"First\"},\"hidden\":false},{\"id\":\"4\",\"enabled\":true,\"type\":\"top_hits\",\"schema\":\"metric\",\"params\":{\"field\":\"time_since_obs_hours\",\"aggregate\":\"concat\",\"size\":1,\"sortField\":\"Timestamp\",\"sortOrder\":\"desc\"},\"hidden\":false},{\"id\":\"6\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"Roster.lastName.keyword\",\"size\":5,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\",\"customLabel\":\"Last\"},\"hidden\":false},{\"id\":\"7\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"Details.PhoneNumber.keyword\",\"size\":5,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\",\"customLabel\":\"Phone\"},\"hidden\":false},{\"id\":\"8\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"bucket\",\"params\":{\"field\":\"Roster.unit.keyword\",\"size\":5,\"order\":\"desc\",\"orderBy\":\"_key\",\"otherBucket\":false,\"otherBucketLabel\":\"Other\",\"missingBucket\":false,\"missingBucketLabel\":\"Missing\"},\"hidden\":false}]}",
        "uiStateJSON": "{\"vis\":{\"params\":{\"sort\":{\"columnIndex\":3,\"direction\":\"asc\"}}}}",
        "description": "",
        "version": 1,
        "kibanaSavedObjectMeta": {
    ...
    {
      "_id": "39b68aa0-a9f8-11eb-b0e5-cf2d289da706",
      "_type": "visualization",
      "_source": {
        "title": "Individual feverish or has a condition follow-up Text",
        "visState": "{\"title\":\"Individual feverish or has a condition follow-up Text\",\"type\":\"markdown\",\"params\":{\"fontSize\":12,\"openLinksInNewTab\":true,\"markdown\":\"# Individual feverish or has a condition follow-up\\nList of individuals whose most recent symptom submission includes \\\"Fever\\\" or any form of condition, within the time-frame specified in the top right corner of the dashboard.\\n## Time Filter\\nTime filter for all data is adjusted at the top-right of the screen and is typically set to \\\"Last 24 Hours\\\".\\n#### Feverish or condition exhibiting individuals to examine\\nA filtered table that shows the reporting status of only individuals whose most recent symptom submission includes \\\"Fever\\\" or any form of condition. Each row in the table shows the EDIPI, score, risk of COVID exposure by category, date and time of last observation, temperature and the number of hours since the last observation.  You may sort by any of the columns.\\nIf an individual submits symptoms multiple times within the time period, this table displays the most recent data.\"},\"aggs\":[]}",
        "uiStateJSON": "{}",
        "description": "",
        "version": 1,
        "kibanaSavedObjectMeta": {
